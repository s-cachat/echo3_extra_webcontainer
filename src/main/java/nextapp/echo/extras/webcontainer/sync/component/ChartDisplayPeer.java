...
import nextapp.echo.extras.app.chart.ChartDisplay;
import nextapp.echo.extras.webcontainer.service.ChartImageService;
...
public class ChartDisplayPeer
    ...
    private String getImageMap(Component comp) {
        ...
        for (int i = 0; i < coll.getEntityCount(); i++) {
        	...
        	sb.append("{ shapeType: '").append(coll.getEntity(i).getShapeType()).append("'");
        	sb.append(", shapeCoords: '").append(coll.getEntity(i).getShapeCoords()).append("'");
        	sb.append(", actionCommand: '").append(chartDisplay.getActionCommands()[i]).append("'");
        	sb.append(", toolTipText: '").append(coll.getEntity(i).getToolTipText()).append("'}");
